...
class Foraging_Training:    
    ...
    def CoinLocation(Folder, experiment, version = 'full_coins'):
        N_coins = 325
    ...
    def ProcessData(Folder, experiment, version, coins = 'full_coins'):
        ...
        see_coin_array, coin_direction_array, reward = Foraging.GeneratePsi(Training_set_cleaned, coin_location, version)
        ...
        return Training_set_cleaned, time_cleaned, see_coin_array, coin_direction_array, reward, Real_reward
...
class Foraging:    
    ...
    def ProcessData(Folder, experiment, version, coins = 'full_coins'):
        ...
        return Training_set_cleaned, time_cleaned, see_coin_array, coin_direction_array, reward, Real_reward, coin_location
    
    
    class env:
        def __init__(self,  coins_location, init_state = np.array([0,0,0,8]), version = 'complete', max_episode_steps = 3000):
    ...
    class env_allocentric_only:
        def __init__(self,  coins_location, init_state = np.array([0,0,0,0]), version = 'complete', max_episode_steps = 3000):
            self.state = init_state
            self.version = version
            self.coin_initial = 0.1*coins_location
            self.coin_location = 0.1*coins_location
