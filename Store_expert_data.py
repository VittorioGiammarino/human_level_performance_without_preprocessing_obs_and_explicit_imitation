...
TrainingSet, Trajectories, Time, Reward_eval_human, Real_Traj_eval_human, Real_Reward_eval_human, Real_Time_eval_human, Coins_location = Show_DataSet(Folders, 'complete', 'full_coins')
_, _, _, Reward_training_human, Real_Traj_training_human, Real_Reward_training_human, Real_Time_training_human = Show_Training(Folders, 'complete', 'full_coins')
